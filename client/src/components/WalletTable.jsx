...
export default function WalletTable(noOfTxs) {
  ...
  const {getUserTxs,address} = useStateContext();
    const fetchTransactions = async (pageNo) => {
        ...
        const data = await getUserTxs(rowsPerPage,offset);
        setRows(data);
